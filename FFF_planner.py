...
if scac != 'nogo':
    ...
    booking_p=re.compile("[1259][0123456789]{8}|[E][BKG0123456789]{11}|[012][PHL0123456789]{9}|[S][-0123456789]{10}|[S][0123456789]{9}|[0O][0123456789VRO]{11}")
                    ...
                    if c != []:
                        ...
                        if pdat is None:
                            input = Pins(Date=lasttom, Driver=None, InBook=inbook, InCon=incon, InChas=inchas,
                                         ...
                                         Unit=None, Tag=None, Phone=None, Carrier=None, Intext=intext, Outtext=outtext)
